...
public class ppRedShort extends  LinearOpMode {
    ...
    private final Pose shootPos = new Pose(102, 102, Math.toRadians(225));

    private final Pose prepPickup1 = new Pose(102, 84, Math.toRadians(0));
    private final Pose pickup1 = new Pose(138, 84, Math.toRadians(0));

    private final Pose prepPickup2 = new Pose(102, 60, Math.toRadians(0));
    private final Pose pickup2 = new Pose(138, 60, Math.toRadians(0));
