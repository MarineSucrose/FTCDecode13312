...
@Autonomous (name="RedShortV2", group="Linear OpMode")
public class redShortV2 extends  LinearOpMode {
    ...
    private final Pose finalShotPos = new Pose(84, 96, Math.toRadians(215));
