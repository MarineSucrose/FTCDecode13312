...
@Autonomous (name="hpSpamBlueFar", group="Linear OpMode")
public class hpSpamBlueFar extends  LinearOpMode {
    ...
    private final Pose pickupHP = new Pose(2, 12, Math.toRadians(90));
